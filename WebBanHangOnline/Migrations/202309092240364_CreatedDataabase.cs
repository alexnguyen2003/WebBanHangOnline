    ...
    public partial class CreatedDataabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Orders", t => t.Oder_Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        SettingKey = c.String(nullable: false, maxLength: 150),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OrderDetail", "Oder_Id", "dbo.Orders");
            ...
            DropIndex("dbo.tb_OrderDetail", new[] { "Oder_Id" });
